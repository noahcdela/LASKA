    ...
    <div class="container">
        ...
        if( !empty($image) ): ?>
            ...
            <!-- <iframe class="featured-album__spotify" src="https://open.spotify.com/embed/album/54YJgyQS1W65cQ6v0aT0M6"
                ...
                <iframe class="featured-album__spotify" src="https://open.spotify.com/embed/album/6NBTSJhxLFYDtUcijADoUK" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </div>
        ...
        <div class="music__links">
            <a target="_blank" href="https://soundcloud.com/user-504760203/sets/fader">Soundcloud&nbsp;➝</a><br>
            <a target="_blank" href="https://laska1.bandcamp.com/album/fader">Bandcamp&nbsp;➝</a><br>
